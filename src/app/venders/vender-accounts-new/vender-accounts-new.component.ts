...
@Component({
  selector: 'app-vender-accounts-new',
  templateUrl: './vender-accounts-new.component.html',
  styleUrls: ['./vender-accounts-new.component.css']
})
export class VenderAccountsNewComponent implements OnInit {
  ...
  ngOnInit() {
    this.dataForm = this.fb.group({
      id: ['', []],
      vender_account_uid: [this.utilService.getUID('vender_accounts_uid'), []],
      vender_uid: ['', []],
      account_no: ['', []],
      iban: ['', []],
      bank_name: ['', []],
